...
const prompt = ai.definePrompt({
  ...
  output: {format: 'json', schema: SuggestDifferentialDiagnosesOutputSchema},
  ...
  {{#if question}}
  When refining your diagnosis, consider the following question from the user: {{{question}}}. Do not change the original diagnosis, but provide a more detailed rationale and if needed, ask a follow-up counter-question in the 'ai-question' field.
  {{/if}}
